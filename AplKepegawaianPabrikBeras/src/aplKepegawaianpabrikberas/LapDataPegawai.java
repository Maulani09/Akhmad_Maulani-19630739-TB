 ...
 * @author LENOVO
 */
public class LapDataPegawai extends javax.swing.JFrame {

    int baris;
    DefaultTableModel tableModel;

    /**
     * Creates new form LapDataPegawai
     */
    public LapDataPegawai() {
        initComponents();
        showdata();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Laporan Data Pegawai", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Tahoma", 1, 18))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        new Koneksi().tampilLaporan("src/laporan/LapDataPegawai.jrxml", "select * from pegawai");     
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LapDataPegawai.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LapDataPegawai().setVisible(true);
            }
        });
    }
